...
<body>
  <main>
    ...
    <section class="sources">
      ...
      <div><strong>Method:</strong> House prices are indexed to 2015, divided by salary growth since 2015, then shown as the percentage above or below that salary-adjusted baseline.</div>
      <div class="missing-note">Greece and the Netherlands are not shown because the required harmonised Eurostat series are incomplete under these filters.</div>
    </section>
  </main>
