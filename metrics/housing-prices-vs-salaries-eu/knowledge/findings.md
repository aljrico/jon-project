...
- The ranked bar chart should retain the EU aggregate from the original reference. A striped "Unión Europea" row works better than a dotted reference line here because it keeps the aggregate visible in the same reading pattern as the countries while still visually marking it as not a country.
